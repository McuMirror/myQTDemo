...
void LoginCode::loginBtnClicked()
{
    ...
    {
        m_pMsgBox = new QMessageBox(QMessageBox::Information, QString::fromLocal8Bit("提示"), QString::fromLocal8Bit("登陆成功"),
            QMessageBox::Ok, this);
    }
    else
    {
        m_pMsgBox = new QMessageBox(QMessageBox::Information, QString::fromLocal8Bit("提示"), QString::fromLocal8Bit("验证码不正确"),
            QMessageBox::Ok, this);
    }
