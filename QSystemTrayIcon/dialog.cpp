...
void Dialog::initTray()
{
    ...
    QAction *shut = new QAction(QString::fromLocal8Bit("退出"),this);                  //菜单中两个动作
    QAction *openNomal = new QAction(QString::fromLocal8Bit("正常显示"),this);
    QAction *qqmsg = new QAction(QString::fromLocal8Bit("QQ消息"),this);
...
void Dialog::closeEvent(QCloseEvent *event)
{
    if(tray->isVisible())
    {
        QMessageBox::about(this,QString::fromLocal8Bit("最小化"),QString::fromLocal8Bit("最小化到托盘"));
        this->hide();
        event->ignore();
    }
