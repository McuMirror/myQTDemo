    ...
    ui(new Ui::Dialog)
{
    ...
    inputBtn->setText(QString::fromLocal8Bit("标准输入对话框实例"));
    ...
    MsgBtn->setText(QString::fromLocal8Bit("标准消息对话框实例"));
    mainLayout->addWidget(MsgBtn,3,1);
    connect(MsgBtn,SIGNAL(clicked()),this,SLOT(showMsgDlg()));

    CustomBtn = new QPushButton;
    CustomBtn->setText(QString::fromLocal8Bit("用户自定义消息对话框实例"));
    label = new QLabel;
...
void Dialog::showCustomDlg()
{
    ...
    customMsgBox.setText(QString::fromLocal8Bit("这是一个用户自定义消息框!"));
