...
int main(int argc, char *argv[])
{
    ...
    if (!mem.create(1))
    {
        myHelper::ShowMessageBoxError(QString::fromLocal8Bit("程序已运行,软件将自动关闭!"));
        return 1;
    }
    ...
    {
        myHelper::ShowMessageBoxError(QString::fromLocal8Bit("数据库文件不存在,程序将自动关闭!"));
        return 1;
    }
    ...
    //if (!DbConn.open())
    //{
        //myHelper::ShowMessageBoxError(QString::fromLocal8Bit("打开数据库失败,程序将自动关闭！"));
        //return 1;
    //}
