...
void frmMain::InitForm()
{
    ...
    menuStyle->addAction(QString::fromLocal8Bit("淡蓝色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("蓝色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("灰色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("黑色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("灰黑色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("白色"), this, SLOT(change_style()));
    menuStyle->addAction(QString::fromLocal8Bit("银色"), this, SLOT(change_style()));
...
void frmMain::InitVideo()
{
    ...
    for (int i = 0; i < 16; i++)
    {
        ...
        VideoLab[i]->setText(QString::fromLocal8Bit("通道%1").arg(i + 1));
    }

    menu = new QMenu(this);
    menu->setStyleSheet("font: 10pt \"微软雅黑\";");
    menu->addAction(QString::fromLocal8Bit("删除当前视频"), this, SLOT(delete_video_one()));
    menu->addAction(QString::fromLocal8Bit("删除所有视频"), this, SLOT(delete_video_all()));
    menu->addSeparator();
    menu->addAction(QString::fromLocal8Bit("截图当前视频"), this, SLOT(snapshot_video_one()));
    menu->addAction(QString::fromLocal8Bit("截图所有视频"), this, SLOT(snapshot_video_all()));
    menu->addSeparator();

    QMenu *menu1 = menu->addMenu(QString::fromLocal8Bit("切换到1画面"));
    menu1->addAction(QString::fromLocal8Bit("通道1"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道2"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道3"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道4"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道5"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道6"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道7"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道8"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道9"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道10"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道11"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道12"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道13"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道14"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道15"), this, SLOT(show_video_1()));
    menu1->addAction(QString::fromLocal8Bit("通道16"), this, SLOT(show_video_1()));

    QMenu *menu4 = menu->addMenu(QString::fromLocal8Bit("切换到4画面"));
    ...
    QMenu *menu9 = menu->addMenu(QString::fromLocal8Bit("切换到9画面"));
    menu9->addAction(QString::fromLocal8Bit("通道1-通道9"), this, SLOT(show_video_9()));
    menu9->addAction(QString::fromLocal8Bit("通道8-通道16"), this, SLOT(show_video_9()));

    menu->addAction(QString::fromLocal8Bit("切换到16画面"), this, SLOT(show_video_16()));
}
