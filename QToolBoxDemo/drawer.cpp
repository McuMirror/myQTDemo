...
Drawer::Drawer(QWidget *parent, Qt::WindowFlags f)
    :QToolBox(parent,f)
{
    setWindowTitle(QString::fromLocal8Bit("My QQ"));  //设置主窗体的标题

    toolBtn1_1 = new QToolButton;
    toolBtn1_1->setText(QString::fromLocal8Bit("张三"));
    ...
    toolBtn1_2->setText(QString::fromLocal8Bit("李四"));
    ...
    toolBtn1_3->setText(QString::fromLocal8Bit("王五"));
    ...
    toolBtn1_4->setText(QString::fromLocal8Bit("小赵"));
    ...
    toolBtn1_5->setText(QString::fromLocal8Bit("小孙"));
    ...
    toolBtn2_1->setText(QString::fromLocal8Bit("小王"));
    ...
    toolBtn2_2->setText(QString::fromLocal8Bit("小张"));
    ...
    toolBtn3_1->setText(QString::fromLocal8Bit("小陈"));
    ...
    toolBtn3_2->setText(QString::fromLocal8Bit("小李"));
    ...
    this->addItem((QWidget*)groupBox1,QString::fromLocal8Bit("我的好友"));
    this->addItem((QWidget*)groupBox2,QString::fromLocal8Bit("陌生人"));
    this->addItem((QWidget*)groupBox3,QString::fromLocal8Bit("黑名单"));
}
