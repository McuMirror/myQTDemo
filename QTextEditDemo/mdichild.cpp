...
MdiChild::MdiChild()
{
    ...
    this->setPalette(palette);
     ...
     /**自定义的右键菜单项目**/
    actUndo = new QAction(QIcon(":/images/undo.png"),QString::fromLocal8Bit("撤销"),this);
    ...
    actRedo = new QAction(QIcon(":/images/redo.png"),QString::fromLocal8Bit("重复"),this);
    ...
    actCut = new QAction(QIcon(":/images/cut.png"),QString::fromLocal8Bit("剪切"),this);
    ...
    actCopy = new QAction(QIcon(":/images/copy.png"),QString::fromLocal8Bit("复制"),this);
    ...
    actPaste = new QAction(QIcon(":/images/paste.png"),QString::fromLocal8Bit("粘贴"),this);
    ...
    actDel = new QAction(QIcon(":/images/stock_delete.png"),QString::fromLocal8Bit("删除"),this);
    ...
    actSelectAll = new QAction(QIcon(":/images/edit-select-all.png"),QString::fromLocal8Bit("全选"),this);
    actSelectAll->setShortcuts(QKeySequence::SelectAll);
    connect(actSelectAll,SIGNAL(triggered()),this,SLOT(selectAll()));

    actFontChang = new QAction(QIcon(":/images/font.png"),QString::fromLocal8Bit("字体设置"),this);
    connect(actFontChang,SIGNAL(triggered()),this,SIGNAL(fontChang()));

    actFontColor = new QAction(QIcon(":/images/textcolor.png"),QString::fromLocal8Bit("字体颜色"),this);
...
void MdiChild::newFile()//新建
{
    ...
    isUntitled = true;
    curFile = QString::fromLocal8Bit("无标题%1").arg(sequenceNumber++);
...
bool MdiChild::loadFile(const QString &fileName)//读取文件
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
        QMessageBox::warning(this, QString::fromLocal8Bit("MDI"),
                             QString::fromLocal8Bit("Cannot read file %1:\n%2.")
                             .arg(fileName)
...
bool MdiChild::saveAs()
{
    QString fileName = QFileDialog::getSaveFileName(
            this,QString::fromLocal8Bit("另存为"),curFile,"(*.txt)"";;All File(*.*)");
...
bool MdiChild::saveFile(const QString &fileName)
{
    ...
    if (!file.open(QFile::WriteOnly | QFile::Text)) {
        QMessageBox::warning(this, QString::fromLocal8Bit("MDI"),
                             QString::fromLocal8Bit("Cannot write file %1:\n%2.")
                             .arg(fileName)
                             .arg(file.errorString()));
        return false;
    }
...
bool MdiChild::maybeSave()//是否保存
{
    if (this->document()->isModified())
    {
        ...
        ret = QMessageBox::warning(this, QString::fromLocal8Bit("警告"),
                     QString::fromLocal8Bit("'%1'内容已修改但尚未保存，是否保存？")
                     .arg(curFile),
