...
void MainBottomFirstWidget::initUI()
{
    ...
    QLabel *safeLabel = new QLabel(u8"查杀修复");
    ...
    QLabel *cleanLabel = new QLabel(u8"电脑清理");
    ...
    QLabel *youhuaLabel = new QLabel(u8"优化加速");
    ...
    QLabel *routerTitle = new QLabel(u8"路由器卫士");
    QFont font = routerTitle->font();
    font.setBold(true);
    font.setPixelSize(15);
    routerTitle->setFont(font);

    QLabel *routerDes = new QLabel(u8"帮您免费升级为智能路由器");
    ...
    advNameList << u8"软件管家" << u8"人工服务" << u8"手机助手" << u8"宽带测速器" ;
