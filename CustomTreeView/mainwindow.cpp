    ...
    , m_menu(NULL)
{
    ...
    QStringList strList;
    strList << QString::fromLocal8Bit("样式一") << QString::fromLocal8Bit("样式二") << QString::fromLocal8Bit("样式三");
    ...
    m_label->setText(QString::fromLocal8Bit("自定义TreeView"));
...
void MainWindow::treeViewCustomContextMenuRequested(const QPoint &pos)
{
    if (m_menu == NULL)
    {
        ...
        expandAllAction->setText(QString::fromLocal8Bit("全部展开"));
        unExpandAllAction->setText(QString::fromLocal8Bit("全部折叠"));
