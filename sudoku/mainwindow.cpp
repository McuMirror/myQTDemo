    ...
    : QMainWindow(parent)
{
    ...
    setWindowTitle(QString::fromLocal8Bit("数独计算器"));
...
void MainWindow::createActions()
{
    ...
    xiakeAction = new QAction(QString::fromLocal8Bit("侠客风云传"), this);
...
void MainWindow::help()
{
    QMessageBox::information(this, QString::fromLocal8Bit("帮助"),
                             QString::fromLocal8Bit("<h2> 数独游戏规则 </h2> \
                                            <p>1.每一行填写1-9不能重复。\
                                                                 <p>2.每一列填写1-9不能重复。\
                                                                                      <p>3.每个宫填写1-9不能重复。\
                                                                                                                                                  ...
                                                                                                                                                  void MainWindow::about()
    {
                                                                                                                                                  QMessageBox::about(this, QString::fromLocal8Bit("关于"),
                                                                                                                                                                     QString::fromLocal8Bit("<h2> 数独计算器 V0.9 </h2> \
    ...
    {
                                                                                                                                                                                                                                                   QMessageBox::information(this, QString::fromLocal8Bit("侠客风云传"),
                                                                                                                                                                                                                                                                            QString::fromLocal8Bit("<h2> 国产单机游戏《侠客风云传》已经开始预售！ </h2> \
