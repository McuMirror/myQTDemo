...
void HistogramView::paintEvent(QPaintEvent *)
{
    ...
    painter.drawText(20,26,QString::fromLocal8Bit("人数"));

    for(int i = 1; i < 5; i++)
    {
        painter.drawLine(-1, -i*50, 1, -i*50);
        painter.drawText(-20, -i*50, QString::fromLocal8Bit("%1").arg(i*5));
    }
    //x 坐标轴
    painter.drawLine(x0, y0, 540, 250);
    painter.drawLine(538, 248, 540, 250);
    painter.drawLine(540, 250, 538, 252);
    painter.drawText(545, 250, QString::fromLocal8Bit("部门"));
