    ...
    ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle(QString::fromLocal8Bit("数独计算器"));
}
...
{
    operaMenu = new QMenu(QString::fromLocal8Bit("操作(&O)"),this);
    ui->menuBar->addMenu(operaMenu);

    runAction = new QAction(QString::fromLocal8Bit("执行"),this);
    runAction->setShortcut(QString::fromLocal8Bit("Ctrl+r"));
    runAction->setStatusTip(QString::fromLocal8Bit("计算数独解法"));
    connect(runAction,SIGNAL(triggered()),this,SLOT(run()));
    operaMenu->addAction(runAction);

    clearAction = new QAction(QString::fromLocal8Bit("初始化"),this);
    clearAction->setShortcut(QString::fromLocal8Bit("ctrl+d"));
    clearAction->setStatusTip(QString::fromLocal8Bit("初始化当前数独表"));
    ...
    quitAction->setStatusTip(QString::fromLocal8Bit("退出程序"));
    connect(quitAction,SIGNAL(triggered()),this,SLOT(close()));
    operaMenu->addAction(quitAction);

    helpMenu = new QMenu(QString::fromLocal8Bit("帮助(&H)"),this);
    ui->menuBar->addMenu(helpMenu);
    aboutAction = new QAction(QString::fromLocal8Bit("关于"),this);
    aboutAction->setShortcut(QString::fromLocal8Bit("Ctrl+I"));
    aboutAction->setStatusTip(QString::fromLocal8Bit("关于数独计算器"));
...
{
    //    QMessageBox::about(this, "关于", QString::fromLocal8Bit("<h1>数独计算器</h1>\n"
    //                                    "数独计算器是一个用于快速求解数独的简单程序,基于Qt5\n"
    //                                    "<h3>Version:%1</h3>"
    //                                    "<p><h3>By:Gxin</h3></p>").arg(version));
    QMessageBox::about(this, QString::fromLocal8Bit("关于"), QString::fromLocal8Bit("数独计算器"));
}
