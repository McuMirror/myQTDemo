...
int main(int argc, char *argv[])
{
    ...
    model.setHeaderData(1, Qt::Horizontal, QString::fromLocal8Bit("出生日期"));
    model.setHeaderData(2, Qt::Horizontal, QString::fromLocal8Bit("职业"));
    model.setHeaderData(3, Qt::Horizontal, QString::fromLocal8Bit("工龄"));
    ...
    tableView.setWindowTitle(QString::fromLocal8Bit("Delegate"));
    tableView.show();
